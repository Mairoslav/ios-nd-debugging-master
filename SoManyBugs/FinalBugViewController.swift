...
class FinalBugViewController: UIViewController {
    ...
    // MARK: 1st Question: Which method "shakes the bugs" off the screen?
    // The disperseBugsAnimation function gets called when the shake motion ends.
...
// MARK: 2nd Question: Which UIEventSubtype member value is being used to "shake the bugs"?
// .motionShake
