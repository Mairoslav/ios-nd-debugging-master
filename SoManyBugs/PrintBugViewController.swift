...
extension PrintBugViewController {
    ...
    override var description: String {
        return "PrintSettingsViewController contains \(bugs.count) bugs."
    }
    
    override var debugDescription: String {
        var index = 0
        var debugString = "PrintSettingsViewController contains \(bugs.count) bugs. \n"
        for bug in bugs {
